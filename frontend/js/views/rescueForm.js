function renderRescueForm() {
    const main = document.querySelector('main');
    
    const HTMLcontent = `<div class="rescue-main">
                            <div class="form-page">
                                <div class="form-title">
                                    <img src="assets/icons/destellos.png" alt="destellos" class="flashes-form">
                                    <h1><span class="home-cover_title-red">Rescata</span> un animal</h1>
                                    <h3>Rellena nuestro formulario y ayúdale a encontrar un hogar</h3>
                                    <img src="assets/icons/flecha.png" alt="flecha" class="arrow-form">
                                </div>
                                <div class="main-form">
                                    <div class="main-form_items">
                                        <h4>Tus datos</h4>
                                        <form class="main-form_item-top">
